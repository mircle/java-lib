package org.quickbundle.third.jasperreport;
...
public class PrintServiceApp extends AbstractSampleApp
{
	...
	public void fill() throws JRException
	{
		...
		JasperPrint jasperPrint = getJasperPrint(null);
	...
	public void print() throws JRException
	{
		...
		exporter.setParameter(JRExporterParameter.INPUT_FILE_NAME, RmPathHelper.getClassRootPath(this.getClass()) + "PrintServiceReport.jrprint");
	 ...
	 *
	 */
	public static JasperPrint getJasperPrint(String str) throws JRException
	{
		//JasperPrint
...
//		jasperPrint.addStyle(italicStyle);
		...
		JRDesignStyle songStyle = new JRDesignStyle();
		songStyle.setName("宋体");
		songStyle.setFontName("宋体");
		songStyle.setFontSize(8);
		songStyle.setItalic(true);
		songStyle.setPdfFontName("宋体");
		songStyle.setPdfEncoding("UTF-8");
		songStyle.setPdfEmbedded(false);
		jasperPrint.addStyle(songStyle);
...
//		image.setRenderer(JRImageRenderer.getInstance(JRLoader.loadBytesFromLocation("jasperreports.png")));
//		page.addElement(image);
		...
		text.setStyle(songStyle);
		text.setFontSize(18);
		text.setText("Applet用于Web打印");
		...
		if(str == null || str.length() == 0) {
			str = "JasperReports is a powerful report-generating tool that has the ability to deliver rich content onto the screen, to the printer or into PDF, HTML, XLS, CSV or XML files.\n\n" +
