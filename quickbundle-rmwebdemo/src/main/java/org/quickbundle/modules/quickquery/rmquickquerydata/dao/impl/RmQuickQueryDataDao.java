//代码生成时,文件路径: E:/platform/myProject/qbrm/code/QbRmWebDemo2/src/main/java/org/quickbundle/modules/quickquery/rmquickquerydata/dao/impl/RmQuickQueryDataDao.java
 ...
 * 
 * 文件名称: org.quickbundle.modules.quickquery.rmquickquerydata.dao.impl --> RmQuickQueryDataDao.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.modules.quickquery.rmquickquerydata.dao.impl;
...
public class RmQuickQueryDataDao extends RmJdbcTemplate implements IRmQuickQueryDataDao, IRmQuickQueryDataConstants {
    ...
    public String insert(RmQuickQueryDataVo vo) {
        ...
        Object[] obj = { vo.getId(), vo.getQuick_query_id(),vo.getOld_resource_name(),vo.getOld_resource_code(),vo.getOld_resource_id_number(),vo.getOld_resource_id_char(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
     ...
     */
	public String[] insert(final RmQuickQueryDataVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmQuickQueryDataVo vo = (RmQuickQueryDataVo)obj;
				return new Object[]{ vo.getId(), vo.getQuick_query_id(),vo.getOld_resource_name(),vo.getOld_resource_code(),vo.getOld_resource_id_number(),vo.getOld_resource_id_char(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
			}
		});
		return ids;
	}
    ...
    public RmQuickQueryDataVo find(String id) {
        return (RmQuickQueryDataVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
    ...
    public int update(RmQuickQueryDataVo vo) {
        Object[] obj = { vo.getQuick_query_id(),vo.getOld_resource_name(),vo.getOld_resource_code(),vo.getOld_resource_id_number(),vo.getOld_resource_id_char(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
     ...
     * @return 成功更新的记录数组
     */
	public int[] update(final RmQuickQueryDataVo[] vos) {
		return batchUpdate(SQL_UPDATE_BY_ID, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmQuickQueryDataVo vo = (RmQuickQueryDataVo)obj;
				return new Object[]{ vo.getQuick_query_id(),vo.getOld_resource_name(),vo.getOld_resource_code(),vo.getOld_resource_id_number(),vo.getOld_resource_id_char(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
			}
		});
	}
    ...
    public List<RmQuickQueryDataVo> queryByCondition(String sql, int startIndex, int size) {
        if(size <= 0) {
