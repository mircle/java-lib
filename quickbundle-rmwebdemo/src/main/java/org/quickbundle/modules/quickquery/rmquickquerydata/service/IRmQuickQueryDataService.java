//代码生成时,文件路径: E:/platform/myProject/qbrm/code/QbRmWebDemo2/src/main/java/org/quickbundle/modules/quickquery/rmquickquerydata/service/IRmQuickQueryDataService.java
 ...
 * 
 * 文件名称: org.quickbundle.modules.quickquery.rmquickquerydata.service --> IRmQuickQueryDataService.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.modules.quickquery.rmquickquerydata.service;
...
public interface IRmQuickQueryDataService {
     ...
     * @param size 查询多少条记录(size小于等于0时,忽略翻页查询全部)
     * @param selectAllClumn 是否查询所有列，即 SELECT * FROM ...(适用于导出)
     * @param referIndexVo 参照索引对象
     * @return 查询到的VO列表
     */
    public List<RmQuickQueryDataVo> queryByCondition(String queryCondition, String orderStr, int startIndex, int size, boolean selectAllClumn, RmQuickQueryVo quickQuery);
	 ...
	 * @return
	 */
	public int executeInitData(RmQuickQueryVo referIndex, String[] ids);
