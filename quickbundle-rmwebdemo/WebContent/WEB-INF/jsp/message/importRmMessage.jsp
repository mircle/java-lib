...
<%@page import="org.quickbundle.tools.helper.RmUploadHelper"%>
...
<%
	...
	if(vo.getSender_id().length() == 0 ) { errorMsg += "Sender_id不能为空;"; }
...
<table class="table_div_content">
	...
	<tr>
		...
		<td>
			<a href="#"><u>批量导入<%=IRmMessageConstants.TABLE_NAME_CHINESE %>模板</u></a>
		</td>
		<td align="right">&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
