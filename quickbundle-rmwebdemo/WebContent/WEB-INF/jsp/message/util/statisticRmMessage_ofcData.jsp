...
<%
	...
	RmProjectHelper.getCommonServiceInstance().doQuery("select parent_message_id as rm_key, count(parent_message_id) as rm_count from RM_MESSAGE group by parent_message_id", new RowMapper() {
...
{
  "title":{
    "text":  "按<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("parent_message_id")%>统计",
  ...
  "elements":[
    {
      ...
      "alpha":     0.5,
      "colour":    "#9933CC",
      "text":      "<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("parent_message_id")%>",
      "font-size": 10,
