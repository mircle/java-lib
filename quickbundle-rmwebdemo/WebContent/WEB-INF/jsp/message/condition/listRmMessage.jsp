...
<script type="text/javascript">
	var rmActionName = "RmMessageConditionAction";
	...
	function toAdd_onClick() {  //到增加记录页面
		form.action="<%=request.getContextPath()%>/modules/message/rmmessage" + rmJspPath + "/insertRmMessage.jsp";
		form.submit();
	}
...
<div id="div_simple">
	<table class="table_query">
		...
		<tr>
			<td align="right"><%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("biz_keyword")%></td>
			<td>
				<input type="text" class="text_field" name="biz_keyword" inputName="<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("biz_keyword")%>" maxLength="25"/>
			</td>
			<td align="right"></td>
			<td></td>
		</tr>
		<tr>
			<td align="right"><%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("sender_id")%></td>
			<td>
				<input type="text" class="text_field" name="sender_id" inputName="<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("sender_id")%>" maxLength="9"/>
			</td>
			<td align="right"></td>
			<td></td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" class="text_field" name="owner_org_id" inputName="<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("owner_org_id")%>" maxLength="25"/>
			</td>
			<td align="right"></td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" class="text_field" name="template_id" inputName="<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("template_id")%>" maxLength="9"/>
			</td>
			<td align="right"></td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" class="text_field" name="is_affix" inputName="<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("is_affix")%>" maxLength="1"/>
			</td>
			<td align="right"></td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" class="text_field" name="record_id" inputName="<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("record_id")%>" maxLength="25"/>
			</td>
			<td align="right"></td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" class="text_field" name="message_xml_context" inputName="<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("message_xml_context")%>" maxLength="32767"/>
...
<table class="tableHeader">
  <tr>
    ...
    <td class="tableHeaderMiddleTd"><b><%=IRmMessageConstants.TABLE_NAME_CHINESE %>列表</b></td>
    <td class="tableHeaderMiddleTd" width="60%" align="right">
    	<%if(!isReadOnly) { %><input type="button" class="button_ellipse" id="button_toAdd" value="新增" onclick="javascript:toAdd_onClick();" title="跳转到新增页面"/>
...
<layout:collection name="beans" id="rmBean" styleClass="listCss" width="100%" indexId="rmOrderNumber" align="center" sortAction="0">
	...
	<layout:collectionItem width="8%" title='<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("biz_keyword")%>' property="biz_keyword" sortable="true"/>
	<layout:collectionItem width="8%" title='<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("sender_id")%>' property="sender_id" sortable="true"/>
	<layout:collectionItem width="8%" title='<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("parent_message_id")%>' property="parent_message_id" sortable="true"/>
	<layout:collectionItem width="8%" title='<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("owner_org_id")%>' property="owner_org_id" sortable="true"/>
	<layout:collectionItem width="8%" title='<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("template_id")%>' property="template_id" sortable="true"/>
	<layout:collectionItem width="8%" title='<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("is_affix")%>' property="is_affix" sortable="true"/>
	<layout:collectionItem width="8%" title='<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("record_id")%>' property="record_id" sortable="true"/>
	<layout:collectionItem width="8%" title='<%=IRmMessageConstants.TABLE_COLUMN_CHINESE.get("message_xml_context")%>' property="message_xml_context" sortable="true"/>
	</layout:collection>
...
%>
autoPatchParentIdName("<%=IRmMessageConstants.DEFAULT_CONDITION_KEY_ARRAY[0]%>");
</script>