...
<input type="hidden" name="parent_message_id" value="<%=RmStringHelper.prt(resultVo.getParent_message_id())%>"><table align="center">
	<tr>
		<td><br>
			<%if(!isReadOnly) { %><input type="button" class="button_ellipse" id="button_update" value="修改" onclick="javascript:find_onClick();">
