...
<script type="text/javascript">
	...
	function toImport_onClick() {  //到导入页面
		window.location="<%=request.getContextPath()%>/modules/message/rmmessage" + rmJspPath + "/importRmMessage.jsp";
	}
	...
	function toAdd_onClick() {  //到增加记录页面
		window.location="<%=request.getContextPath()%>/modules/message/rmmessage" + rmJspPath + "/insertRmMessage.jsp";
	}
...
<div id="div_funcNode" style="padding:20px 10px 10px 0px; display:none" align="right">
	<a class="aul" target="_blank" href="<%=request.getContextPath()%>/modules/message/rmmessage/ajax/listRmMessage.jsp">Ajax</a>
	<a class="aul" target="_blank" href="<%=request.getContextPath()%>/modules/message/rmmessage/util/statisticRmMessage_chart.jsp">图表统计</a>
	<a class="aul" target="_blank" href="<%=request.getContextPath()%>/modules/message/rmmessage/util/statisticRmMessage_ofc.jsp">Flash图表</a>
	<a class="aul" target="_blank" href="<%=request.getContextPath()%>/RmMessageAction.do?cmd=statistic">交叉统计</a>
	<a class="aul" target="_blank" href="<%=request.getContextPath()%>/RmMessageReadOnlyAction.do?cmd=queryAll">只读模式</a>
	</div>
<%-- end --%>
