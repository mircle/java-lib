...
<table class="table_div_content">
	...
	<%
		...
		m.put("biz_keyword", IRmMessageConstants.TABLE_COLUMN_CHINESE.get("biz_keyword"));
		
		m.put("sender_id", IRmMessageConstants.TABLE_COLUMN_CHINESE.get("sender_id"));
		
		m.put("parent_message_id", IRmMessageConstants.TABLE_COLUMN_CHINESE.get("parent_message_id"));
		
		m.put("owner_org_id", IRmMessageConstants.TABLE_COLUMN_CHINESE.get("owner_org_id"));
		
		m.put("template_id", IRmMessageConstants.TABLE_COLUMN_CHINESE.get("template_id"));
		
		m.put("is_affix", IRmMessageConstants.TABLE_COLUMN_CHINESE.get("is_affix"));
		
		m.put("record_id", IRmMessageConstants.TABLE_COLUMN_CHINESE.get("record_id"));
		
		m.put("message_xml_context", IRmMessageConstants.TABLE_COLUMN_CHINESE.get("message_xml_context"));
