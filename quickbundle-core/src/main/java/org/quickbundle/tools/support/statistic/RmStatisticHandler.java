...
public class RmStatisticHandler {
    ...
    private String[] rowKeyFieldAll = new String[0];
    private String[] columnKeyFieldAll = new String[0];
    private IStatisticData myStatisticData = null;
    private IFormatDouble myFormatDouble = null;
    
    private String rowColumnKeyFieldDisplay = null;
